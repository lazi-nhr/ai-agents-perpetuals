...
python get_funding.py --perp-list ./perp_list.txt --start 2025-03-22 --end 2025-08-22 --out-dir ./hyperliquid_funding

Resume from partial parquet files (do not re-download finished coins):
python get_funding.py --perp-list ./perp_list.txt --start 2025-03-22 --end 2025-08-22 --out-dir ./hyperliquid_funding --resume

Force overwrite final files even if they exist:
python get_funding.py --perp-list ./perp_list.txt --start 2025-03-22 --end 2025-08-22 --out-dir ./hyperliquid_funding --force

Change how the script treats HTTP 500 windows:
# treat 500 as empty (default)
python get_funding.py --on-500 empty ...
# attempt recursive split on 500
python get_funding.py --on-500 split ...
# skip the whole coin on 500
python get_funding.py --on-500 skip-coin ...

Adjust concurrency and global rate:
python get_funding.py --perp-list ./perp_list.txt --workers 4 --rps 1.0 --out-dir ./out_dir

Example with more options and verbose logs:
python get_funding.py --perp-list ./perp_list.txt --start 2025-01-01 --end 2025-06-01
